...
public class WidgetManager : IDisposable
{
    ...
    public void LoadWidgets()
    {
        try
        {
            ...
            var shadowCopyDir = Path.Combine(ShadowCopyPath, Guid.NewGuid().ToString());
